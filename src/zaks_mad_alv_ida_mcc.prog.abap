...
DATA : lo_container2 TYPE REF TO cl_gui_custom_container,
       lo_disp_text  TYPE REF TO cl_gui_textedit,
       lv_text       TYPE string.
  ...
  TRY.
      cl_salv_gui_table_ida=>create_for_cds_view(
              EXPORTING
                  ...
                  io_gui_container = lo_container1
              RECEIVING
...
*----------------------------------------------------------------------*
  ...
  CREATE OBJECT lo_disp_text
    EXPORTING
      parent = lo_container2.

  lv_text = |NOTE:\n| && |*PT NA* -- Procurement Type - Not Available!|.
  lo_disp_text->set_textstream( lv_text ).
  lo_disp_text->set_readonly_mode( 1 ).
